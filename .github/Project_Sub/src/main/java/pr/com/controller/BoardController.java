...
import pr.com.service.BoardService;
import pr.com.service.ReplyService;
import pr.com.dto.BoardDTO;
import pr.com.dto.Criteria;
import pr.com.dto.PageMaker;
...
public class BoardController {
	...
	public String updateView(BoardDTO boardDTO, @ModelAttribute("scri") SearchCriteria scri, Model model) throws Exception{
	...
	public String update(BoardDTO boardDTO, @ModelAttribute("scri") SearchCriteria scri, RedirectAttributes rttr) throws Exception{
		logger.info("update");
