...
public class MyNoticeService {
    ...
    public NoticePageDto selectSearchNoticePageById(final int displayUnit, final int curPage, String keyword, String searchtype, int categoryId, String memberId) {
        ...
        final MemberPageDto memberPageDto = new MemberPageDto(page.getStartNum(), page.getEndNum(), keyword, searchtype, categoryId, memberId);
